...
def fam_kin_syn_classif(input_data):
    """
    This functions creates SGD classifiers using kinematic synergies
...
def fam_syn_single_source_classification(type, discard):
    """
    This functions is used as an interface to create SGD classifiers using
    kinematic synergies and progressively discarding them.
    It bins the trials and targets the trial family
    It uses mini-batch approach
    """
