...
def split(data):
    """
    This function adds the task number, the EP number in the trial, the EP nuber in total,
    the given object for the trial, the asked object for the trial and the family for both.
    """
